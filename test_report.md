...
통합 보고서 최종 갱신 시각: 2026-08-02 20:43:58
총 구동 세션 수: 1개 세션
...
- **[2025-01-10 09:00:30]** Track 2 함정(Trap) 구축 완료: ATM: 377.5, 설치 수량: 1계약
- **[2025-01-10 09:00:30]** Track 4 Basecamp: ATM: 377.5 양매수 진입


### 💰 1. 자산 및 자본 종합 요약
- **시작 총자산 (Starting Equity)**: ₩25,003,773
- **종료 총자산 (Ending Equity)**: ₩24,996,655
- **실현/평가 순손익 (Net Profit)**: **₩-7,118 (-0.028%)**
- **최대 낙폭 (Max Drawdown, MDD)**: ₩13,516 (0.054%)
...
| :--- | :--- | :--- | :--- | :--- |
| **Track1 (Defense)** | ₩-1,672 | ₩+0 | 30.0% | 리스크 급증 시 100% 비중으로 증거금 제한 및 숏옵션 커버 |
| **Track2 (Trap)** | ₩-1,115 | ₩+0 | 10.0% | ⛔ **[V2 HOLD]** 박스권 내 역추세 포지션 진입 중단 |
| **Track3 (Arbitrage)** | ₩+0 | ₩+0 | 5.0% | ⛔ **[V2 HOLD]** 시뮬레이션 순도 유지를 위한 차익 진입 전면 차단 |
| **Track4 (Gamma)** | ₩-557 | ₩+0 | 5.0% | ⛔ **[V2 HOLD]** 현물 델타 헤징 및 스켈핑 중단 |
