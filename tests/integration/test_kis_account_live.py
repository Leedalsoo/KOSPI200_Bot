...
class TestKISAccountLiveVTS:
    ...
    def setup_adapter(self):
        """환경변수에서 자격증명 및 계좌번호를 로드하여 Adapter 설정."""
    ...
    def test_live_vts_account_inquiry(self):
        ...
        try:
            ...
            print(f"\n[LIVE VTS ACCOUNT SUCCESS] total_balance={summary.total_balance}, free_margin={summary.free_margin}, used_margin={summary.used_margin}")
